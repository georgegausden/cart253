...
Pirates: The Sequel: An interactive game where the user must either destroy all enemy boats or collect enough treasure to claim victory.
**************************************************/
...
let portNames = ['Silvercreek Harbor', 'Stormbreaker Harbor', 'Whisperwind Port', 'Outvern Harbor', 'Bursport Port', 'Shrewster Port', 'Penecier Harbor']

//preloads all the assets in the game (sounds, images and fonts)
function preload() {
  //all assets were taken online, from either youtube videos for the sound effects or google images for the various image assets
